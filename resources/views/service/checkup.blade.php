...
<section class="service-detail">
    ...
    <div class="detail-container">
        ...
        <div class="detail-banner">
            ...
            <img src="{{ asset('images/checkup.webp') }}">
        ...
        <div class="detail-content">
            ...
            <p>
                Routine medical check up can be an early detector to recognize any unusual condition or disease that affects your pets.
            </p>

            <p>
                We recommend pet owners perform routine health examinations to maintain overall health and detect problems as early as possible.
            </p>

            <ul>
                <li>Respiratory diseases</li>
                <li>Gastrointestinal diseases</li>
                <li>Dermatological diseases</li>
